...
public class McpToolRegistry {
    ...
    public McpToolRegistry(McpProperties properties) {
        this(properties, null);
    }

    public McpToolRegistry(McpProperties properties, TenantIsolation tenantIsolation) {
        this.tenantIsolation = tenantIsolation;
        if (properties != null && properties.getTools() != null) {
            properties.getTools().forEach(this::register);
        }
    }
