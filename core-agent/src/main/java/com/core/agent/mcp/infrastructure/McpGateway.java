...
public class McpGateway implements McpToolGateway {
    ...
    public McpGateway(McpToolRegistry toolRegistry,
        ...
        this(toolRegistry, serviceResolver, protocolConverter, tenantIsolation, properties, new ObjectMapper());
    }
    ...
    public McpGateway(McpToolRegistry toolRegistry,
        ...
        this.properties = properties == null ? McpProperties.builder().build() : properties;
